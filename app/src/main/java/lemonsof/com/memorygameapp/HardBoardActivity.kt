...
class HardBoardActivity : AppCompatActivity() {
    ...
    lateinit var tv_hard_board_movements: TextView
    lateinit var tv_hard_board_missing: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonConfig.getConfigForHard()
        commonConfig.getGeneralConfigs()


        val tv_hard_board_time: TextView = findViewById(R.id.tv_hard_board_time)
        val btn_hard_board_retornar: Button = findViewById(R.id.btn_hard_board_retornar)
        tv_hard_board_movements = findViewById(R.id.tv_hard_board_movements)
        tv_hard_board_missing = findViewById(R.id.tv_hard_board_missing)
        tv_hard_board_movements.text = hisotirialMovimientos.toString()
        tv_hard_board_missing.text = commonConfig.restantesMovimientos.toString()
        ...
        counter = object : CountDownTimer(commonConfig.timeLength, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                tv_hard_board_time.text = if (time >= 10) "00:$time" else "00:0$time"
            }
        ...
        btn_hard_board_retornar.setOnClickListener {
            finish()
        }

        images = arrayOf(
            findViewById(R.id.img_hard_board_1),
            findViewById(R.id.img_hard_board_2),
            findViewById(R.id.img_hard_board_3),
            findViewById(R.id.img_hard_board_4),
            findViewById(R.id.img_hard_board_5),
            findViewById(R.id.img_hard_board_6),
            findViewById(R.id.img_hard_board_7),
            findViewById(R.id.img_hard_board_8),
            findViewById(R.id.img_hard_board_9),
            findViewById(R.id.img_hard_board_10),
            findViewById(R.id.img_hard_board_11),
            findViewById(R.id.img_hard_board_12),
            findViewById(R.id.img_hard_board_13),
            findViewById(R.id.img_hard_board_14),
            findViewById(R.id.img_hard_board_15),
            findViewById(R.id.img_hard_board_16),
            findViewById(R.id.img_hard_board_17),
            findViewById(R.id.img_hard_board_18),
            findViewById(R.id.img_hard_board_19),
            findViewById(R.id.img_hard_board_20),
            findViewById(R.id.img_hard_board_21),
            findViewById(R.id.img_hard_board_22),
            findViewById(R.id.img_hard_board_23),
            findViewById(R.id.img_hard_board_24),
            findViewById(R.id.img_hard_board_25),
            findViewById(R.id.img_hard_board_26),
            findViewById(R.id.img_hard_board_27),
            findViewById(R.id.img_hard_board_28),
            findViewById(R.id.img_hard_board_29),
            findViewById(R.id.img_hard_board_30)
        )
    ...
    private fun increaseMocements(source: ImageView) {
        ...
        if (movimientos == 2) {
            ...
            tv_hard_board_missing.text = (missing).toString()
